	...
	<tbody>
		...
		foreach($lstArticles as $tintuc) {
			...
			?>
				...
				<td id="td_title" align="left"><?php echo $tintuc["tintuc"]["title"]?></td>
				<td id="td_datemodified" align="left"><?php  echo $html->format_date($tintuc["tintuc"]["datemodified"],'d/m/Y H:i:s')?></td>
				<td id="td_usermodified" align="left"><?php echo $tintuc["tintuc"]["usermodified"]?></td>
				<td id="td_viewcount" align="center"><?php echo $tintuc["tintuc"]["viewcount"]?></td>
				<td id="td_active" align="center">
					<?php 
					if($tintuc["tintuc"]["active"]==0) {
				...
				<td id="td_id" style="display:none;"><?php echo $tintuc["tintuc"]["id"]?></td>
				<td id="td_alias" style="display:none;"><?php echo $tintuc["tintuc"]["alias"]?></td>
				<td id="td_imagedes" style="display:none;"><?php echo $tintuc["tintuc"]["imagedes"]?></td>
				<td id="td_contentdes" style="display:none;"><?php echo $tintuc["tintuc"]["contentdes"]?></td>
				<td align="center">
