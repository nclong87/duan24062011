<?php
	$linktmp = BASE_PATH.'/tintuc/danhsachbaiviet';
?>
...
<table width="99%">
	...
	<tbody>		
		...
		foreach($lstArticles as $tintuc) {
			$alink = BASE_PATH."/tintuc/view/".$tintuc["tintuc"]["id"]."/".$tintuc["tintuc"]["alias"];
			$atitle = $tintuc["tintuc"]["title"];
			$aimage = $tintuc["tintuc"]["imagedes"];
			$aintro = $tintuc["tintuc"]["contentdes"];
			?>
			<tr>
				<td align="left">
